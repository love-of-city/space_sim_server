...
def observation():
    return {
        ...
        'ik_elbow_preference': {'enabled': True, 'status': 'active', 'measured_height_m': .02,
            'reference_height_m': .021, 'position_offset_m': .0003,
            'wrist_enabled': True, 'measured_wrist_drop_m': -.01, 'reference_wrist_drop_m': -.009,
            'preferred_wrist_drop_m': .05, 'wrist_objective_active': True,
            'joint3_enabled': True, 'joint3_objective_active': True,
            'measured_joint3_rad': .2, 'reference_joint3_rad': .199,
            'preferred_joint3_upper_rad': -.0872664626,
            'base_posture_cost': .4, 'predicted_posture_cost': .399},
