...
> Archive note: this document records the integration baseline and verification results for this date; it is not a description of all later changes.
...
The earlier `2026_09_20_主分支合并后仿真验收.md` and `2026_09_20_zmh_v1主线整合.md` describe their
