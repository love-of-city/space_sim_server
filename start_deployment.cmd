...
"%PWSH%" -NoLogo -NoProfile -ExecutionPolicy RemoteSigned -File "%~dp0scripts\deployment_launcher.ps1" -Action Start %*
set "RESULT=%ERRORLEVEL%"
if not "%RESULT%"=="0" (
    echo.
    echo Start failed. Read the error above. Existing services may still be running.
    pause
)
exit /b %RESULT%
